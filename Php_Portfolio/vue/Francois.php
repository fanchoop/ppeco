...
<<<<<<< HEAD
	...
	<title>Portefeuille de compétence BTS SIO</title>
...
<body>
	...
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand"><img src="img/francois.jpg" data-active-url="img/logo1.png" alt=""></a>
			</div>
			<!-- Collect the nav links, forms, and other content for toggling -->
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right main-nav">
					<li onclick="location.href='accueil.php';"><a>Accueil</a></li>
					<li><a href="#services">PPE</a></li>
					<li><a href="#team">Activité</a></li>
					<li><a href="#team">Stage</a></li>
				...
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
							<h3 class="light white">&lt;/&gt; François DANET &lt;/&gt;</h3>
							<h1 class="white typed">Portefeuille de compétence BTS SIO SLAM</h1>
			...
			<div class="row intro-tables">
				<div class="col-md-4">
					<div class="intro-table intro-table-first">
						<h5 class="white heading">Projets Encadrés</h5>
						<div class="owl-carousel owl-schedule bottom">
							<div class="item">
								<div class="schedule-row row">
									<div class="col-xs-10 text-left">
										<h5 class="Black">Portfolio web</h5>
									</div>
								</div>
								<div class="schedule-row row">
									<div class="col-xs-6">
										<h5 class="regular black">PHP</h5>
										<h5 class="regular black">MySQL</h5>
										<h5 class="regular black">HTML</h5>
										<h5 class="regular black">CSS</h5>
									</div>
								</div>
							</div>
							<div class="item">
								<div class="schedule-row row">
									<div class="col-xs-20 text-left">
										<h5 class="Black">Java DataBase Connectivity</h5>
									</div>
								</div>
								<div class="schedule-row row">
									<div class="col-xs-6">
										<h5 class="regular black">Java</h5>
										<h5 class="regular black">SQL Express</h5>
										<h5 class="regular black">IHM Swing</h5>
									</div>
								</div>
							</div>
							<div class="item">
				...
				<div class="col-md-4">
					...
					<div class="intro-table intro-table-hover">
						...
						<div class="bottom">
							...
							<a href="#" class="btn btn-white-fill expand">?</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-table intro-table-third">
						...
						<div class="owl-testimonials bottom">
							<div class="item">
								<h4 class="white heading content">!</h4>
								<h5 class="white heading light author">alexis</h5>
							</div>
							<div class="item">
								<h4 class="white heading content">!</h4>
								<h5 class="white heading light author">rene</h5>
							</div>
							<div class="item">
								<h4 class="white heading content">!</h4>
								<h5 class="white heading light author">Bernard</h5>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="row no-margin">
				<div class="col-md-7 no-padding col-md-offset-5 pricings text-center">
					<div class="pricing">
						<div class="box-main active" data-img="img/header.jpg">
		...
		<div class="modal-dialog">
			<div class="modal-content modal-popup">
				...
				<h3 class="white">Connexion</h3>
 				<form action="Traitement.php" class="popup-form" method="post">
 						Login :
	...
	</div>			<h3 class="white">Déconnexion</h3>
	<footer>
		<div class="container">
			<div class="row">
			...
			<div class="row bottom-footer text-center-mobile">
				<div class="col-sm-8">
					<p>&copy;François DANET. 2018</p>
				</div>
				<div class="col-sm-4 text-right ">
					<ul class="social-footer">
						<li><a href="https://www.facebook.com/reg/"><i class="fa fa-facebook"></i></a></li>
...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>BTS SIO Slam Vannes</title>
<meta name="description" content="coucou" />
<meta name="keywords" content="test" />
<meta name="author" content="test2" />
<!-- Favicons (created with http://realfavicongenerator.net/)-->
...
<body>
		...
		<div class="container">
			...
			<div class="navbar-header">
				<button type="button" class="navbar-toggle collapsed"
					...
					<span class="sr-only">TEST</span> <span class="icon-bar"></span> <span
						class="icon-bar"></span> <span class="icon-bar"></span>
				</button>
				<a class="navbar-brand" href="#"><img src="img/logo.png"
					data-active-url="img/logo-active.png" alt=""></a>
			</div>
			<!-- Collect the nav links, forms, and other content for toggling -->
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right main-nav">
					...
					<li><a href="#services">PPE</a></li>
					<li><a href="#team">Activite</a></li>
					<li><a href="#pricing">Curriculum Vitae</a></li>
					<li><a href="#" data-toggle="modal" data-target="#modal1"
						class="btn btn-blue">Connexion...</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
		...
		<div class="container">
			<div class="table">
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
							<h3 class="light white">Brevet de technicien supérieur</h3>
							<h1 class="white typed">Services informatiques aux organisations</h1>
							<span class="typed-cursor">|</span>
						</div>
					</div>
				</div>
			...
			<div class="row services">
				<div class="col-md-4">
					<div class="service">
						...
						<h4 class="heading">Cardio Training</h4>
						<p class="description">A elementum ligula lacus ac quam ultrices a
							scelerisque praesent vel suspendisse scelerisque a aenean hac
							montes.</p>
					</div>
				</div>
				<div class="col-md-4">
	...
	<section id="pricing" class="section">
		<div class="container">
			<div class="row title text-center">
				<h2 class="margin-top white">Pricing</h2>
				<h4 class="light white">Choose your favorite pricing plan and sign
					up today!</h4>
			</div>
			<div class="row no-margin">
				<div
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="col-sm-6 text-center-mobile">
					<h3 class="white">Reserve a Free Trial Class!</h3>
					<h5 class="light regular light-white">Shape your body and improve
						your health.</h5>
			...
			<div class="row bottom-footer text-center-mobile">
				...
				<div class="col-sm-4 text-right text-center-mobile">
					<ul class="social-footer">
						<li><a href="https://www.facebook.com/reg/"><i
